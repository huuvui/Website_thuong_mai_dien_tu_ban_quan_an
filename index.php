    ...
    <div class="boxcenter">
        ...
        <div class="row mb ">
            <div class="boxtrai mr">
                ...
                <marquee><p><span style="font-size: 20px; color: white; background-color:grey">Top những sản phẩm bán chạy nhất hiện nay!</span></p></marquee>     
                <div class="row">
                <?php
            ...
            <div>
              <ul>
                ...
                if($_SESSION["user_type"] == 2) {
                    ...
                    echo '<li><a href="dathang.php">Lịch sử đơn hàng</a></li>'; 
                                    }
                    echo '
                    <li>
                    </li>
