        ...
        <div class="row mb ">
            <div class="boxtrai mr">
                ...
                <div class="banner">
                    ...
                    <marquee><p><span style="font-size: 20px; color: white; background-color:grey">Top những quyển sách bán chạy nhất hiện nay!</span></p></marquee>     
                    <div class="row">
                <?php
...
$sql = "SELECT tensp,hinhsp,cost,ban FROM sanpham where daban < 100 ";
...
?>
            ...
            if($_SESSION["user_type"] == 2) {
                ...
                echo ' <li><a href="qldonhang.php">Quản lí đơn đặt hàng</a></li>';
               echo ' <li><a href="danhsachdon.php">Xem danh sách đơn hàng</a></li>';
               echo '<li><a href="dssanpham.php">Xem danh sách sản phẩm</a></li>';
                echo '<li><a href="xemlienhe.php">Xem liên hệ</a></li>';
                echo '<li><a href="xemuser.php">Xem danh sách người dùng</a></li>';
      ...
      ?>
                    ...
                    <div class="boxtitle">DANH MỤC NỔI BẬT</div>
                    <div class="boxcontent2 menudoc">
                        <ul>
                    ...
                    <div><img src="images/13.png" width="100%" height="30%"></div>
               </div>
                </div>
